...
export const ZoteroPlugin: Plugin = async () => ({
  tool: {
    zotero_count: tool({
      description: "Use when you only need the total number of items in the Zotero library.",
      args: {},
      async execute() {
    ...
    zotero_stats: tool({
      description: "Use when you need aggregate library statistics such as summary, item types, years, tags, or attachment counts.",
      args: {
    ...
    zotero_check_pdfs: tool({
      description: "Use when you need a summary of which Zotero items are missing PDFs.",
      args: {
        collection: tool.schema.string().optional().describe("Optional collection key filter"),
      },
      async execute(args) {
    ...
    zotero_crossref: tool({
      description: "Use when you need to match citation text against the local Zotero library.",
      args: {
    ...
    zotero_find_dois: tool({
      description: "Use when you need CrossRef-powered DOI backfilling for local Zotero items.",
      args: {
    ...
    zotero_fetch_pdfs: tool({
      description: "Use when you need to discover or attach open-access PDFs for Zotero items.",
      args: {
